...
public final class ArithDecoder extends ArithCoder {
     ...
     */
    public final BitInput _in;

    /** Current bits for decoding.
     */
    public long _value; // implied = 0;

    /** Value will be <code>true</code> if the end of stream has
     * been reached.
     */
    public boolean _endOfStream = false;

    /** Number of bits that have been buffered.
     */
    public int _bufferedBits; // implied = 0;
     ...
     */
    public void bufferBit() throws IOException {
	if (_in.endOfStream()) {
	    if (_bufferedBits == 0) {
		_endOfStream = true;
		return;
