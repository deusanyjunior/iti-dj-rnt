...
public final class ArithEncoder extends ArithCoder {
     ...
     */
    public final BitOutput _out;

    /** Number of bits beyond first bit that were normalized.
     */
    public int _bitsToFollow; // implied = 0;
     ...
     * @since 1.1
     */
    public void bitPlusFollowTrue() throws IOException {
     ...
     * @since 1.1
     */
    public void bitPlusFollowFalse() throws IOException {
